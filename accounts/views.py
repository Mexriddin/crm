...
def userPage(request):
	...
	contex= {'orders':orders,'total_orders':total_orders,  'delivered':delivered, 
	'pending':pending }
...
def accountSettings(request):
	...
	contex={"form":form}
	return render(request,'accounts/account_settings.html',contex)
...
def createOrder(request, pk):
	...
	if request.method == "POST":
		...
		if formset.is_valid():
			formset.save()
			return redirect('/')
	contex = {'formset':formset,'customer':customer}
...
def updateOrder(request, pk):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			return redirect('/')
	contex = {'form':form}
	return render(request,'accounts/update_form.html',contex)
